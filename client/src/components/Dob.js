  ...
  return (
    ...
    <div id="dobBack">
      <div >
        ...
        <input placeholder="Choose Date of Birth" className="form-control mt-3"  type="text" onFocus={(e) => e.target.type = 'date'}  id="dateOfBirth" onChange={handelDob}/>
        <button className="btn-hover color-11 mt-5" onClick={handelSubmit}>Submit</button>
        <h6 style={{color:"white", textAlign:"center", marginTop:"15px", fontSize:"12px"}}>By entering this site you are agreeing with our term of use and privicy policy.</h6>
      </div>
    </div>
